...
export const BIP39_WORDLIST: string[] = [
  ...
  'away','awe','awesome','awful','awkward','axis','baby','bachelor','bacon','badge',
  ...
  'chimney','choice','choose','chronic','cinnamon','circle','citizen','city','civil','claim',
  ...
  'enable','enact','endless','endorse','enemy','engage','engine','enhance','enjoy','enlist',
  'enough','enrich','enroll','ensure','enter','entire','entry','envelope','episode','equal',
  'equip','erase','erosion','escape','essay','essence','estate','eternal','ethics','evidence',
  ...
  'express','extend','extra','eye','fable','face','faculty','fade','faint','faith',
  'fall','false','fame','family','famous','fancy','fantasy','far','fashion','fat',
  ...
  'guard','guide','guilt','guitar','gun','gym','habit','hair','half','hamster',
  ...
  'lock','logic','lonely','long','loop','lottery','loud','loyal','lucky','luggage',
  ...
  'market','marriage','mask','master','match','material','math','matrix','matter','maximum',
  'maze','meadow','mean','medal','media','melody','melt','member','memory','mention',
  'menu','mercy','merge','merit','merry','mesh','message','metal','method','middle',
  'midnight','milk','million','mimic','mind','minimum','minor','miracle','miss','mixed',
  ...
  'near','neck','need','negative','neglect','neither','nephew','nerve','network','news',
  ...
  'obey','object','oblige','obscure','observe','obtain','occur','ocean','october','odor',
  ...
  'own','oyster','ozone','packet','paddle','page','pair','palace','palm','panda',
  'panel','panic','panther','paper','parade','parent','park','parrot','party','pass',
  'patch','path','patrol','pause','pave','payment','peace','peanut','peasant','pelican',
  ...
  'polar','pole','police','pond','pony','popular','portion','position','possible','post',
  'potato','pottery','poverty','powder','power','practice','praise','predict','prefer','prepare',
  'present','pretty','prevent','price','pride','primary','print','priority','prison','private',
  'prize','problem','process','produce','profit','program','project','promote','proof','property',
  'prosper','protect','proud','provide','public','pudding','pull','pulp','pulse','pumpkin',
  'punch','pupil','puppy','purchase','purity','push','put','puzzle','pyramid','quality',
  ...
  'ride','rifle','right','rigid','ring','riot','ripple','risk','ritual','rival',
  'river','road','roast','robot','robust','rocket','romance','roof','rookie','rotate',
  ...
  'shy','sibling','siege','sight','sign','silent','silk','silly','silver','similar',
  ...
  'talent','tamper','tank','tape','target','task','tattoo','taxi','teach','team',
  ...
  'title','toast','today','together','toilet','token','tomato','tomorrow','tone','tongue',
  'tonight','tool','tooth','top','topic','topple','torch','tornado','tortoise','toss',
  'total','tourist','toward','tower','town','toy','track','trade','traffic','tragic',
  'train','transfer','trap','trash','travel','tray','treat','tree','trend','trial',
  'tribe','trick','trigger','trim','trip','trophy','trouble','truck','truly','trumpet',
  'trust','truth','tube','tuition','tumble','tuna','tunnel','turkey','turn','turtle',
  ...
  'wave','way','wealth','weapon','wear','weasel','web','wedding','weekend','weird',
